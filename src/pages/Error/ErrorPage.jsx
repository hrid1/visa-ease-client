  ...
  return (
    <div className="h-screen">
      <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
        <div className="container flex flex-col items-center justify-center mx-auto my-8 space-y-8 text-center sm:max-w-md">
          <svg
          ...
          <Link
            ...
            className="px-8 py-3 font-semibold rounded dark:bg-emerald-500 dark:text-gray-50"
          >
            Back to homepage
          </Link>
        </div>
